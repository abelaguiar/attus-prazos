...
public record PrazoResponse(
        @Schema(description = "Identificador do prazo", example = "1") Long id,
        ...
        @Schema(description = "Descricao objetiva do ato ou compromisso", example = "Contestacao")
                String descricao,
        @Schema(description = "Data limite do prazo", example = "2026-12-31") LocalDate dataPrazo,
        @Schema(description = "Status do prazo", example = "PENDENTE") StatusPrazo status,
        @Schema(
                        description = "Indica se o prazo pendente ja passou da data limite",
                        example = "false")
                boolean vencido,
        @Schema(description = "Data e hora de criacao", example = "2026-06-18T20:00:00Z")
                Instant criadoEm,
        @Schema(
                        description = "Data e hora de cumprimento, quando houver",
                        example = "2026-06-18T21:30:00")
